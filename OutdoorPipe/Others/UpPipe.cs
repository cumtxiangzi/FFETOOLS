...
namespace FFETOOLS
{
    ...
    public class UpPipe : IExternalCommand
    {
        ...
        {
            double num = UnitUtils.Convert(Convert.ToDouble(1500), DisplayUnitType.DUT_MILLIMETERS, DisplayUnitType.DUT_DECIMAL_FEET);
            Reference reference = uidoc.Selection.PickObject(ObjectType.Element, "请选择需要末端绘制立管的管道");
