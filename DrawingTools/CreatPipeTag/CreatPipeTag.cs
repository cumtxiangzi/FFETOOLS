...
namespace FFETOOLS
{
    ...
    public class ExecuteEventCreatPipeTag : IExternalEventHandler
    {
        ...
        public bool CreatDemensionEP(Document doc, UIDocument uidoc) //创建设备间尺寸标注
        {
            try
            {
                ...
                using (Transaction trans = new Transaction(doc, "创建设备间尺寸标记"))
                {
                    trans.Start();
